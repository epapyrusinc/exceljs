...
class CellXform extends BaseXform {
  ...
  reconcile(model, options) {
    ...
    // look for hyperlink
    const hyperlinkData = options.hyperlinkMap[model.address];
    if (hyperlinkData) {
      ...
      model.hyperlink = hyperlinkData.hyperlink;
      if (hyperlinkData.tooltip) {
        model.tooltip = hyperlinkData.tooltip;
      }
    }
