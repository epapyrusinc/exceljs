...
class Cell {
  ...
  get model() {
    ...
    if (this._styleId !== undefined) model.styleId = this._styleId;
    else delete model.styleId;
    if (this._comment) {
  ...
  set model(value) {
    ...
    // Preserve raw cell style index attribute (`s`) if present in the loaded model.
